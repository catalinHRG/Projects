...
public class ClosableTabbedPane extends JTabbedPane implements DropTargetListener {
          ...
          @Override
          public void drop(DropTargetDropEvent dtde) { // new tab created on drop 

                    DropData dd = new DropData();
                    dd.dataTransfer(dtde);
                    
                    CustomTextArea tabEditor = new CustomTextArea();
                    tabEditor.append(dd.fileContent);
                    JScrollPane scrollContainer = new JScrollPane(tabEditor);
                    this.addTab(dd.fileName, scrollContainer);
                    this.setSelectedComponent(scrollContainer);
          }
